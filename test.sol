...
// All rights reserved to AlexNa Holdings, Inc

// Savva Token Interface
// by @AlexNa

pragma solidity ^0.8.18;


abstract contract ISavvaToken is ERC20, Ownable {
...
// basic ERC-20 token. Nothing special...
// by @AlexNa

pragma solidity ^0.8.18;


contract SavvaToken is ISavvaToken {
    IConfig public config;

    constructor(address _config) ERC20("Content Reward Token", "SAVVA") {
    ...
    function mint(uint256 amount) public override onlyOwner {
        require(
            msg.sender == owner() ||
                msg.sender == config.getAddress("contract_savvaFaucet"),
            "Only owner or faucet can mint"
        );
        _mint(owner(), amount);
    }
    ...
    function burnFrom(address account, uint256 amount) public override {
        // it allows to burn tokens from any account after approval
        _spendAllowance(account, msg.sender, amount);
        _burn(account, amount);
    }
}

// Processed by Dirty Solidity Flattener by AlexNa 
// https://github.com/lexansoft/dirty-solidity-flattener 
